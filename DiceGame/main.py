...
class DiceGame(QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("QMainWindow { border-image: url(background.jpg); "
    ...
    def show_play1(self):
        text = "player 1 won : %d, even : %d"%(self.player1.won, self.player1.even)
        self.wonlabel.setText(text)
    
    def show_play2(self):
        text = "player 2 won : %d, even : %d"%(self.player2.won, self.player2.even)
        self.wonlabel.setText(text)  
